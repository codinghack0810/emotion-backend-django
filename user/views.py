...
# @csrf_exempt    
# async def generateimage1(request):
...
#         with open(f"C:/spain backend/spain backend/emotion/a.png", "wb") as f:
...
#                 print(data)
            ...
            #         with open(f"C:/spain backend/spain backend/emotion/v1_txt2img_{i}.png", "wb") as f:
            #             f.write(base64.b64decode(image["base64"]))
                
            #     if data:
            #         return HttpResponse({"url":"okay"})
            # except:
            #     pass
